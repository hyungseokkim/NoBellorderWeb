...
<br><br>
	...
	<form:form id="event2" name="event2" method="post">
	
	
		<input type="hidden" name="menu_number" id="menu_number" />


			<c:forEach var="result" items="${identify}" varStatus="status">	
					<center>
						...
						<table width="95%" height="240" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<p>
									...
									<font color="black" size="3.5"><b>${result.check_number}</b></font>
									<br>
								
									<font color="black" >혜택내용:&nbsp;${result.table_number}</font>
								<font color="black" >메뉴:&nbsp;${result.menu_number}</font>
								</p>
								</td>
							</tr>
